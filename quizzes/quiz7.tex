...
%%\newpage
\begin{questions}
\question For the function $\displaystyle f(x) = x+9/x+2$,
\begin{parts}

  \part[6] Find the critical points.
  \vfill

  \part[6] Determine the intervals where the function is increasing and decreasing.
  \vfill
  
  \part[3] Determine the relative maximum and minimum points.
  \vfill
