...
\begin{questions}
\addpoints
\question Evaluate each limit it it exists.
\begin{parts}
\part[2] $\displaystyle \lim_{x\rightarrow -2} \frac{x^2-4}{x+2}$
  \vfill

  \part[2] $\displaystyle \lim_{x\rightarrow\infty} \frac{4x^2-1}{x+2}$
    \vfill
\end{parts}


\question[6] for the function
$$
