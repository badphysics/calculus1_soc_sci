...
%%\newpage
\begin{questions}
  \question[15pts] What production level will maximize profits for a company with cost and demand functions
  $$
C(x) = 3800 + 5x -\frac{x^2}{1000}, \;\;\;\; \text{and} \;\;\;\; p(x) = 50-\frac{x}{100}.
  $$
Be sure to verify that you have indeed found a maximum.
