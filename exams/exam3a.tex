...
\addpoints
\begin{questions}
\question Find $\displaystyle\frac{dy}{dx}$ for the following expressions
\begin{parts}
  \part[5] $y^2x+xy=1$
  \vfill

  \part[5] $\sqrt[3]{y} + xy = 2x$
  \vfill
...
\addpoints
\question For the function $f(x) =x^4-4x^2$
\begin{parts}
  ...
  \part[3] Find the critical numbers of $f(x)$.
  \vfill

  \newpage
  \addpoints

  \part[5] Find the intervals where $f(x)$ is increasing and decreasing and determine any relative maximum or minimum values.
  \vfill


  \part[5] Find the intervals of concavity.
  \vfill
